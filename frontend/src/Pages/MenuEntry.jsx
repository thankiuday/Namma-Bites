    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-4">
            <button onClick={() => navigate(-1)} className="px-4 py-2 bg-orange-600 text-white rounded hover:bg-orange-700 transition-colors font-semibold w-full sm:w-auto">
              &larr; Back
            </button>
          </div>
          {/* Form Section */}
      ...
      {isEditModalOpen && (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full flex items-center justify-center z-50">
          <div className="bg-white p-4 md:p-8 rounded-lg shadow-xl w-full max-w-md mx-auto">
            {/* Modal Back Button */}
            <button onClick={() => setIsEditModalOpen(false)} className="mb-4 px-4 py-2 bg-orange-600 text-white rounded hover:bg-orange-700 transition-colors font-semibold w-full sm:w-auto">
              &larr; Back
            </button>
